      ...
      <div className="w-100% h-[calc(100vh-100px)] flex justify-center items-center flex-col">
        <div className="bg-[hsla(0,0%,100%,1)] w-[95%] h-[90%] rounded-3xl border border-[hsla(0,0%,80%,1)]">
          <div className="w-[25%] border-r border-[hsla(0,0%,80%,1)] text-center inline-block mt-[30px]">
            ...
            <div className="w-full h-70 overflow-y-scroll mt-[10px] flex flex-col items-center">
              {subjects.map(subject => (
                <div className={`text-2xl font-semibold h-[20%] w-[90%] p-[10px] flex items-center justify-center rounded-[10px] mb-[10px] cursor-pointer ${selectedSub === subject ? "bg-[hsla(210,86%,92%,1)]" : "bg-transparent"}`} 
                  key={subject}
          ...
          <div className="w-[25%] border-r border-[hsla(0,0%,80%,1)] text-center inline-block mt-[30px]">
            ...
            <div className="w-full h-70 overflow-y-scroll mt-[10px] flex flex-col items-center">
              {classes.map(num => (
                <div className={`text-2xl font-semibold h-[20%] w-[90%] p-[10px] flex items-center justify-center rounded-[10px] mb-[10px] cursor-pointer ${selectedClass === num ? "bg-[hsla(210,86%,92%,1)]" : "bg-transparent"}`} 
                  key={num}
          ...
          <div className="w-[25%] border-r border-[hsla(0,0%,80%,1)] text-center inline-block mt-[30px]">
            ...
            <div className="w-full h-70 overflow-y-scroll mt-[10px] flex flex-col items-center">
              {students.map(student => (
                <div className={`text-2xl font-semibold h-[20%] w-[90%] p-[10px] flex items-center justify-center rounded-[10px] mb-[10px] cursor-pointer ${
          ...
          <div className="flex gap-[20px] text-2xl font-semibold ml-[40px] mb-[10px]">
          ...
          <div className="h-[30%] flex">
            {mode === '사진' ?
            <div className="ml-[20px] border border-dashed border-[hsla(0,0%,80%,1)] w-[73%] h-[100%] rounded relative pl-[20px] pr-[20px] inline-block">
              { previews.length > 0 ?
              ...
              <div className={`h-full w-full flex items-center overflow-x-scroll gap-[10px] pt-[10px] pb-[10px] ${previews.length > 0 ? "justify-start" : "justify-center"}`}>
                {previews.length > 0 ? (
            ...
            : <div className="ml-[20px] border border-[hsla(0,0%,80%,1)] w-[73%] h-[100%] rounded relative pl-[20px] pr-[20px] inline-block">
                ...
                <hr />
                <textarea placeholder="내용을 입력하세요." className="w-full h-[50%] mt-[10px] resize-none focus:outline-none" defaultValue={content} onChange={(e) => setContent(e.target.value)}/>
            </div>}
            <div className="flex flex-col w-[24%] items-center">
              <div className="w-full h-[70%] flex">
                <div className="border-r border-[hsla(0,0%,80%,1)] w-[43%] h-full flex flex-col ml-[15px] justify-center font-semibold">
                ...
                <div className="flex w-[43%] h-full items-center justify-center">
