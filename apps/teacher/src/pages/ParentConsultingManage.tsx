      ...
      <div className="w-full h-[calc(100vh-100px)] flex justify-center items-center flex-col">
        <div className="bg-[hsla(0,0%,100%,1)] w-[95%] h-[90%] rounded-3xl border border-[hsla(0,0%,80%,1)] flex justify-center">
          <div className="flex flex-col w-[30%] items-center">
            <h2 className="bg-blue-500 w-[90%] h-[50px] text-white text-2xl font-semibold text-center leading-[50px] rounded-2xl mt-[30px]">학부모 상담 {dummy.length}건</h2>
              ...
              {dummy.map(item => 
                <div 
                  ...
                  className={`w-full h-[50px] border mb-5 rounded-md flex justify-center items-center cursor-pointer pl-[10px] pr-[10px] box-border transition-colors ${
                    selected?.id === item.id ? 'bg-blue-400 text-white border-blue-400 font-semibold' : 'bg-white text-black border-[#0257A3]'
                  }`}
          ...
          <div className="flex flex-col w-[65%] items-center">
            ...
            <div className="w-[90%] h-[80%] mt-[30px] rounded-xl flex flex-col items-center bg-blue-50 overflow-hidden">
              <div className="flex w-[90%] mt-[20px] h-[40px] pl-[20px] pr-[20px] rounded-xl justify-between items-center bg-white">
                <h2 className="text-xl">제목 : {selected?.title}</h2>
                <small className="bg-gray-100 text-[#00162E] font-semibold w-[130px] text-center h-[25px] leading-[25px] rounded-md">{selected?.parent} 학생 학부모</small>
              </div>
              ...
              <div className="w-[90%] flex-1 mt-[20px] rounded-xl] pl-[15px] pr-[15px] flex flex-col overflow-hidden bg-white rounded-xl">
                <h2 className="font-semibold h-[50px] flex items-center text-xl border-b-2 border-gray-300 justify-between">
                  ...
                  <div className="bg-gray-100 pr-[10px] pl-[10px] rounded-xl flex items-center h-[25px] gap-7">
                    <input type="date" className="text-sm w-[110px]"/>
                    <input type="time" className="text-sm w-[105px]"/>
                  </div>
                </h2>
